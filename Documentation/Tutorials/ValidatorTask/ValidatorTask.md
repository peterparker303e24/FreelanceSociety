...
Once you have completed the instructions in the task description, you should have a ZIP file with the contents that meet all the task specification conditions and all ethics requirements conditions. If you are using the task from the previous section, then you can use the ZIP file [here](https://base.freelancesociety.app/Submissions/ValidatorSubmissions/6bfdd52a384ec3147c32962ccf3615526faf7144a7706c3db554aad116be4539/Submission.zip) (open the link in a new tab). The ZIP file should be uploaded within your base route with the path "Submissions/ValidatorSubmissions/6bfdd52a384ec3147c32962ccf3615526faf7144a7706c3db554aad116be4539/Submission.zip".
